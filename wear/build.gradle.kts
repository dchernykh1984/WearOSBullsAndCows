...
android {
    namespace = "com.dchernykh.bullsandcows"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dchernykh.bullsandcows"
    ...
    reports {
        filters {
            excludes {
                ...
                packages("com.dchernykh.bullsandcows.ui", "com.dchernykh.bullsandcows.store")
                classes("com.dchernykh.bullsandcows.MainActivity*")
            }
        }
        verify {
            rule {
                // What is left is the rules, the scoring, the history window,
                // the record decision, the round-screen layout and the view model
                // that drives them - all plain Kotlin, and none of it with any
                // excuse for being uncovered.
                minBound(80)
            }
        }
    }
