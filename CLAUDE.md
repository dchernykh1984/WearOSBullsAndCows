# Working on Bulls & Cows

Bulls and Cows for Wear OS watches, in Kotlin and Jetpack Compose: the code-breaking
game where every guess returns bulls, the digits right and in place, and cows, the
digits present but elsewhere. Everything runs on the watch - no phone, no network, no
account. `README.md` says what the app is; this file is how work is done here. Longer
procedures live in `.claude/skills/`.

## How the code is laid out

One Gradle module, `:wear`, under `com.dchernykh.bullsandcows`:
...
| `BullsAndCowsViewModel.kt` | the hub between the rules and the screen |
